...
class Patient extends Model
{
    ...
    }//static -> so self this don't work
    ...
    public function getChronicDiseasesAttribute($value)
    {
        return self::decryptField($value);
    }
    public function getMedicationAllergiesAttribute($value)
    {
        return self::decryptField($value);
    }
    public function getPermanentMedicationsAttribute($value)
    {
        return self::decryptField($value);
    }
    ...
    public function getPreviousIllnessesAttribute($value)
    {
        return self::decryptField($value);
    }
}